...
public class AnimeHepler {
     ...
     * @param friction
     */
    public void scalSpringAnime(final View view, float currentValue, float endValue, double tension, double friction) {

        BaseSpringSystem mSpringSystem = SpringSystem.create();
        Spring mScaleSpring = mSpringSystem.createSpring();
        ...
        mScaleSpring.setCurrentValue(currentValue);
        mScaleSpring.setEndValue(endValue);
    }
