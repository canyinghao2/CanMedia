package com.canyinghao.otherlibrary.swipe;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    private Drawable mShadowLeft = new BitmapDrawable();

    private Drawable mShadowRight = new BitmapDrawable();

    private Drawable mShadowBottom = new BitmapDrawable();
