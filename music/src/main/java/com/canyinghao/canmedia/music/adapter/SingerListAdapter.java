...
import com.canyinghao.canmedia.music.activity.MusicListActivity;
       ...
       final PlaylistBean bean=list.get(i);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                IntentHelper.getInstance().showIntent(context, MusicListActivity.class,new String[]{"bean"},new Serializable[]{bean},true);
            }
        });
