...
import com.canyinghao.canmedia.music.utils.PlaylistUtils;
import com.canyinghao.canmedia.music.view.MusicView;
    ...
    public void click(View v){
        ...
        switch (v.getId()){
            ...
            case R.id.histroy_music:
                ...
                IntentHelper.getInstance().showIntent(this,MusicListActivity.class,new String[]{Constant.history},new String[]{Constant.history},true);


                break;
            case R.id.playlist_music:

                IntentHelper.getInstance().showIntent(this,MusicListActivity.class,new String[]{Constant.playList},new String[]{Constant.playList},true);
