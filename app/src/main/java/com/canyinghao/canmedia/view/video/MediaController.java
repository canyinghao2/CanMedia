...
package com.canyinghao.canmedia.view.video;
...
public class MediaController extends FrameLayout {
	...
	private void updatePausePlay() {
		...
		if (mPlayer.isPlaying())
			mPauseButton.setImageResource(R.mipmap.ic_pause_grey);
		else
			mPauseButton.setImageResource(R.mipmap.ic_play_arrow_grey);
	}
