package com.canyinghao.canmedia.adapter.picture;
...
import com.canyinghao.canmedia.view.flipviewpager.BaseFlipAdapter;
 ...
 */
public class PictureListAdapter extends BaseFlipAdapter<PictrueItemBean> {

    private final int PAGES = 3;
    private int[] IDS_INTEREST = {R.id.interest_1, R.id.interest_2, R.id.interest_3, R.id.interest_4, R.id.interest_5};

    public PictureListAdapter(Context context, List<PictrueItemBean> items, FlipSettings settings) {
        super(context, items, settings);
    }

    @Override
    public View getPage(int position, View convertView, ViewGroup parent, PictrueItemBean friend1, PictrueItemBean friend2) {
        ...
        switch (position) {
            ...
            case 1:
                holder.leftAvatar.setImageURI(Uri.parse("file://"+friend1.getPath()));
                LogHelper.loge("file://"+friend1.getPath());
                if (friend2 != null) {

                    holder.rightAvatar.setImageURI(Uri.parse("file://"+friend2.getPath()));
                    LogHelper.loge("file://"+friend2.getPath());
                }
                break;
            default:
    ...
    private void fillHolder(FriendsHolder holder, PictrueItemBean pictureBaseBean) {
...
//            iViews.next().setText(iInterests.next());
        holder.infoPage.setBackgroundColor(context.getResources().getColor(pictureBaseBean.getBackground()));
        holder.nickName.setText(pictureBaseBean.getPath());
    }
